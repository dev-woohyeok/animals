...
**총 길이:** 100초 (8개 프롬프트 — Scene 1,2,5,6: 15초 / Scene 3a,3b,4a,4b: 10초)
...
이 장면: 돌진 — 양 떼가 안전한 언덕 꼭대기. Possum이 돌아서서 언덕 아래 코요테 2마리를 향해 전속력으로 달려감. 첫 번째 코요테에 머리를 박아 들이받음.

1인칭 POV 핸드폰 영상. 한 손 촬영. 흔들리고 불안정한 아마추어 푸티지. 멀리서 촬영.

미국 미주리 농장. 목초지 언덕. 오후. 흐린 하늘.

수컷 미니 포트벨리 돼지 "Possum" 한 마리. 약 15kg. 순백색 짧은 털. 분홍색 피부가 살짝 비침. 언덕 꼭대기에서 돌아서서 아래로 돌진.

코요테 2마리. 회색-갈색 거친 털. 날카로운 노란 눈. 언덕 아래에서 위를 올려다봄.

30대 초반 백인 여성의 손. 카키색 작업 조끼 소매 보임. (1인칭 POV 촬영자 — 멀리서 촬영)

(0-1초) 참조 이미지 프레임.
— 1초에 빠른 화면 전환 —
(1-5초) 언덕 꼭대기. Possum이 양 떼를 등지고 돌아선다. 코요테를 향해 짧은 다리로 언덕 아래를 향해 전속력 돌진. 작은 하얀 몸이 코요테를 향해 달려감. 여자가 울면서 소리를 지름.
— 자연스러운 화면 전환 —
(5-10초) Possum이 첫 번째 코요테에 정면으로 머리를 박아 들이받음. 코요테가 옆으로 밀려남. 흙먼지가 일어남. 두 번째 코요테가 Possum 옆으로 다가옴.

No background music. Possum 돌진 소리, 머리 부딪치는 소리, 코요테 으르렁 소리, 흙먼지 소리, 여자 울면서 소리지르는 소리.
```

---

## Scene 4b: 사투 (The Fight)
...
- EN: "They bit him dozens of times
...
```
// Story: 전체: 농장에서 버려진 미니 돼지 Possum이 양 몰이를 배움 → 코요테 2마리가 양 떼를 노림 → Possum이 양을 언덕 위로 피신시키고 혼자 돌아가 코요테에 맞섬 → 귀 하나를 잃지만 양 전부 구함 → 수술 후 회복 → 양 몰이 복귀.
앞 장면: Possum이 언덕 아래로 돌진해 첫 번째 코요테를 들이받았다. 두 번째 코요테가 다가오고 있다.
이 장면: 사투 — 두 번째 코요테가 Possum 옆구리를 물어 끌어당김. Possum이 물린 채로 버티며 밀어붙임. 코요테 2마리가 결국 퇴각. Possum이 비틀거리며 서 있음.

1인칭 POV 핸드폰 영상. 한 손 촬영. 흔들리고 불안정한 아마추어 푸티지. 멀리서 촬영.

미국 미주리 농장. 목초지 언덕 아래. 오후. 흐린 하늘.

수컷 미니 포트벨리 돼지 "Possum" 한 마리. 약 15kg. 순백색 짧은 털. 분홍색 피부가 살짝 비침. 코요테에 물린 채 버티고 있음. 몸에 상처.

코요테 2마리. 회색-갈색 거친 털. 날카로운 노란 눈. Possum을 물고 끌어당기다 결국 퇴각.

30대 초반 백인 여성의 손. 카키색 작업 조끼 소매 보임. (1인칭 POV 촬영자 — 멀리서 촬영)

(0-1초) 참조 이미지 프레임.
— 1초에 빠른 화면 전환 —
(1-5초) 두 번째 코요테가 Possum 옆구리를 물어 끌어당김. Possum이 몸을 비틀며 버팀. 흙먼지가 일어남. Possum이 물린 채로 코요테에 맞서 밀어붙임.
— 자연스러운 화면 전환 —
(5-10초) 코요테 2마리가 결국 뒤로 물러나 숲 방향으로 도망감. Possum이 비틀거리며 혼자 서 있음. 몸에 상처. 언덕 위에서 양들이 내려다봄. 카메라 심하게 흔들림. 여자 울음소리.

No background music. 코요테 으르렁 소리, 몸이 부딪치고 구르는 소리, Possum 거친 숨소리, 코요테 도망가는 발소리, 여자 울음소리.
```
...
| 4a | Then he turned around / And ran straight at them alone | 그리고 돌아섰다 / 혼자서 코요테를 향해 달렸다 | 반전형 |
| 4b | They bit him dozens of times / He never backed down | 수십 번을 물렸다 / 한 발짝도 물러나지 않았다 | 대비형 |
