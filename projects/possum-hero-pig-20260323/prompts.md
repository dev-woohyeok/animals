...
수컷 미니 포트벨리 돼지 "Possum" 한 마리. 약 15kg. 순백색 짧은 털. 분홍색 피부가 살짝 비침. 양 떼 앞에 서서 양들을 언덕 위로 밀어 올림. 급박하게 뛰어다님.
...
— 자연스러운 화면 전환 —
(5-10초) 작은 Possum이 흩어지는 양들 사이를 미친듯이 뛰어다니며 양들을 언덕 위로 몰아감. 코요테 한 마리가 양 한 마리를 향해 달려오자 Possum이 사이에 뛰어들어 몸으로 막아섬. 코요테가 잠시 멈칫.
— 자연스러운 화면 전환 —
(10-15초) Possum이 코요테를 향해 돌진하며 머리로 들이받음. 코요테가 뒤로 밀려남. 그 틈에 양 떼가 언덕 꼭대기로 올라감. 두 번째 코요테가 옆에서 다가옴. 여자가 소리를 지름.

No background music. 양 울음소리, 코요테 으르렁 소리, Possum 달리는 소리, 몸이 부딪치는 소리, 여자 소리지르는 소리, 바람소리.
```
...
수컷 미니 포트벨리 돼지 "Possum" 한 마리. 약 15kg. 순백색 짧은 털. 분홍색 피부가 살짝 비침. 언덕 꼭대기에 서 있다가 돌아서서 아래로 달려감.
...
(0-1초) 참조 이미지 프레임.
— 1초에 빠른 화면 전환 —
(1-5초) 언덕 꼭대기. Possum이 양 떼 앞에 서 있다. 뒤의 양들은 안전. 아래에서 코요테 2마리가 올라오고 있다. Possum이 돌아서서 언덕 아래로 전속력 돌진. 작은 하얀 몸이 코요테를 향해 달려감. 여자가 울면서 소리를 지름.
— 자연스러운 화면 전환 —
(5-10초) Possum이 첫 번째 코요테에 머리를 박아 들이받음. 코요테가 옆으로 밀려남. 두 번째 코요테가 Possum 옆구리를 물어 끌어당김. Possum이 몸을 비틀며 버팀. 흙먼지가 일어남.
— 자연스러운 화면 전환 —
(10-15초) Possum이 물린 채로 코요테에 맞서 밀어붙임. 코요테 2마리가 결국 뒤로 물러나 숲 방향으로 도망감. Possum이 비틀거리며 서 있음. 몸에 상처. 카메라 심하게 흔들림. 여자 울음소리.

No background music. Possum 돌진 소리, 코요테 으르렁 소리, 몸이 부딪치고 구르는 소리, 흙먼지 소리, 여자 울면서 소리지르는 소리.
```
